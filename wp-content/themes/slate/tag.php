        ...
        <div class="blog-cols">
            ...
            <section class="col-primary">
                <div class="post-list-heading">
                    <h2><?php _e( 'Tagged: ', 'mfc' ); ?><em><?php echo single_tag_title(); ?></em></h2>
                    <?php if( tag_description() ) : ?><p><?php echo tag_description(); ?></p><?php endif; ?>
                    <a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ) ?>">Clear Tag Filter</a>
                </div>
